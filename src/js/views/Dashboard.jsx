class Dashboard extends React.Component {
  ...
  beginRecording() {
    store.dispatch({ type: UPDATE_SESSION, payload: { recording: true, searchString: '' } });
  ...
  render() {
    ...
    return (
      <div className="dashboard mdl-layout__content fx-column fx-center">
        <div className={store.getState().app.searchString ? 'show' : 'hidden'}>Searhing: {store.getState().app.searchString}</div>
        <div className={"recording " + (store.getState().app.searchString ? 'hidden' : 'show')}>
        ...
        <div className={store.getState().app.searchString ? 'hidden' : 'show'}>
        ...
        <div className={"loader " + (store.getState().app.searchString ? 'show' : 'hidden')}>
